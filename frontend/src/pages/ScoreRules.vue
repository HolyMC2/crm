    ...
    <div class="flex min-h-0 flex-1">
      ...
      <div class="scb min-h-0 flex-1 overflow-y-auto p-5">
        ...
        >
          ...
          <span class="flex-none rounded-md px-2 py-[3px] text-[12px] font-bold" :class="r.points >= 0 ? 'text-ink-green-8 bg-surface-green-2' : 'text-ink-red-7 dark:text-ink-red-8 bg-surface-red-1'">
            {{ r.points >= 0 ? '+' : '' }}{{ r.points }}
          </span>
