<template>
  ...
  >
    <div class="flex h-8 items-center text-3xl-semibold text-ink-gray-8">
      {{ __('Data') }}
      <Badge
  ...
  <div
    ...
    class="flex flex-1 flex-col items-center justify-center gap-3 text-3xl-medium text-ink-gray-6"
  >
