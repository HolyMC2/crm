  ...
  <template v-if="media.length || canCancel">
    ...
    <div class="mb-1 flex flex-wrap gap-2">
      ...
      <button
        ...
        class="flex size-16 flex-col items-center justify-center gap-0.5 rounded-md border border-dashed border-outline-gray-3 text-ink-gray-5 hover:border-green-500 dark:hover:border-green-400 hover:text-ink-green-6 disabled:opacity-50"
