  ...
  <div v-if="rows.length" class="mx-3 mb-2 rounded-lg border border-outline-amber-4 bg-surface-amber-1 px-3 py-2.5 sm:mx-10">
    ...
    <div v-for="r in rows" :key="r.name" class="mt-1.5 first:mt-0">
      <textarea
        ...
        rows="2"
        class="scb mb-1.5 w-full resize-none rounded-md border border-outline-amber-4 bg-surface-base px-2 py-1.5 text-[12.5px] text-ink-gray-8 focus:outline-none dark:bg-surface-gray-2"
      />
