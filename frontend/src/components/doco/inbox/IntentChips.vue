...
<template>
  <div v-if="chip" class="flex-none px-3 py-1.5">
    <button
      type="button"
      class="press inline-flex items-center gap-1.5 rounded-full border border-outline-blue-1 bg-surface-blue-1 px-3 py-1 text-[12px] font-semibold text-ink-blue-3 hover:bg-surface-blue-2"
      :title="label"
      :aria-label="label"
      @click="onTap"
    >
